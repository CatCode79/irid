...
fn main() {
    ...
    const SHADER_WGSL_FILEPATH: &str = "D:/_BLACK_ABYSS_DUNGEON/_BAD/bad/learnwgpu/learnwgpu_07_instancing/assets/shader.wgsl";
    ...
    const TREE_FILEPATH: &str = "D:/_BLACK_ABYSS_DUNGEON/_BAD/bad/learnwgpu/learnwgpu_07_instancing/assets/happy-tree.png";
