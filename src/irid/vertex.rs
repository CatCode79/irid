...
pub const VERTICES: &[Vertex] = &[
    Vertex { position: [-0.08682410,  0.49240386, 0.0], /*color: [0.10, 0.0, 0.50],*/ tex_coords: [0.4131759000, 0.007596140] },  // 0
    Vertex { position: [-0.49513406,  0.06958647, 0.0], /*color: [0.20, 0.0, 0.40],*/ tex_coords: [0.0048659444, 0.430413540] },  // 1
    Vertex { position: [-0.21918549, -0.44939706, 0.0], /*color: [0.25, 0.0, 0.25],*/ tex_coords: [0.2808145300, 0.949397057] },  // 2
    Vertex { position: [ 0.35966998, -0.34732910, 0.0], /*color: [0.40, 0.0, 0.50],*/ tex_coords: [0.8596700000, 0.847329110] },  // 3
    Vertex { position: [ 0.44147372,  0.23473590, 0.0], /*color: [0.50, 0.0, 0.10],*/ tex_coords: [0.9414737000, 0.265264100] },  // 4
];
