...
impl SwapChain {
    pub(crate) fn new(device: &std::rc::Rc<wgpu::Device>, surface: &wgpu::Surface, swap_chain_desc: wgpu::SwapChainDescriptor) -> Self {
    ...
    pub(crate) fn update(&mut self, surface: &wgpu::Surface, size: winit::dpi::PhysicalSize<u32>) {
